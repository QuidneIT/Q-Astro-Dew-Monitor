...
; Last Updated on 22/12/2022 (UTC)
;
...
#define SourcePath = "<Source Location>"
...
DefaultDirName="{commoncf}\ASCOM\{#AppName}"
DisableDirPage=yes
...
UninstallFilesDir="{commoncf}\ASCOM\Uninstall\{#AppName}"
...
[Dirs]
Name: "{commoncf}\ASCOM\Uninstall\{#AppName}"
...
Name: "{autoprograms}\{#AppName}"; Filename: "{app}\{#MainFile}"
;Name: "{autodesktop}\{#AppName}"; Filename: "{app}\{#MainFile}"; 
